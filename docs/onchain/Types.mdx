...
- aliases types and structs types will be retreived by the `type` static property of the classes (explained in the dedicated section for [aliases](./Values/aliases) and [structs](./Values/Structs/definition))
