...
We call these "**utility terms**" and are covered more in depth in the [standard library section](../../stdlib/utility_terms/index.md); but is good having in mind that these exsists as they makes our life much easier while writing a program.
